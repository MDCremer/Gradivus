...
\\(\\'([^\\']+|\\'{2})+\\',[xX]\\'([0-9A-Fa-f]{2})+\\',\\':([^\\']+|\\'{2})+:\\',[0-9]+\\);$");
 identigiloj=QRegularExpression("^INSERT\\sOR\\sREPLACE\\sINTO\\sidentigiloj\\s\\(etno,nomo,lingvo,tipo,citajxo,referenco,u\
uid,subskribo,stato\\)\\sVALUES\\s\\(\\'[A-Z]{2}\\',\\'([^\\']+|\\'{2})+\\',\\'[a-z]{2}\\',[0-1]+,(NULL|[xX]\\'([0-9A-Fa-f]\
