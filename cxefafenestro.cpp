...
{QWebEngineSettings *foliumiloAgordoj=QWebEngineSettings::globalSettings();
 ...
 etnoNomoj=QStringList()
   ...
   <<tr("KI: kiribatanoj")
   <<tr("KM: komoranoj")
   <<tr("KN: anoj de Sankta Kristoforo kaj Neviso")
   <<tr("KP: nord-koreanoj")
   <<tr("KR: koreanoj")
   <<tr("KW: kuvajtanoj")
   ...
   <<tr("MZ: mozambikanoj")
   <<tr("NA: namibianoj")
   <<tr("NE: ni\304\235eranoj")
   <<tr("NG: ni\304\235erianoj")
   <<tr("NI: nikeragvanoj")
   <<tr("NL: nederlandanoj")
   <<tr("NO: norvegoj")
   <<tr("NP: nepalanoj")
   ...
   <<tr("SY: sirianoj")
   <<tr("SZ: svazioj")
   <<tr("TL: orienta-timoranoj")
   <<tr("TR: turkoj")
   <<tr("US: usonanoj")
   <<tr("VC: sent-vincentanoj kaj grenadinanoj")
   <<tr("WS: samoanoj")
   <<tr("YE: jemenanoj")
   <<tr("ZA: sud-afrikanoj")
   <<tr("ZM: zambianoj")
